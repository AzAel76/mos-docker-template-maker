...
var moduleMap = {
	"vue": {
		get: () => () => __federation_import(new URL("__federation_shared_vue-rtDHdMUa.js", import.meta.url).href),
		import: true
	},
	"vuetify": {
		get: () => () => __federation_import(new URL("__federation_shared_vuetify-BL3u9EQl.js", import.meta.url).href),
		import: true
	}
};
